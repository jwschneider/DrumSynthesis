...
Kick::Kick() {
	...
	configParam(MID_TONE_PARAM, -2.f, 2.f, 0.f, "Midrange Tone FQ", "Hz", 2, dsp::FREQ_A4);
	configParam(MID_CHARACTER_PARAM, -2.f, 2.f, 0.f, "Midrange Character Param FQ", "Hz", 2, dsp::FREQ_A4);
