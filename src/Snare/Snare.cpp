...
Snare::Snare() {
	...
	configParam(BASEFQ_PARAM, -3.28950661719f, 0.71049338281f, -1.28950661719f, "Drum Base Frequency", "Hz", 2, dsp::FREQ_C4);
	...
	configParam(HARMONIC1_PARAM, -2.62148837674, 1.37851162325f, -0.62148837674, "Harmonic 1 Frequency", "Hz", 2, dsp::FREQ_C4);
	configParam(HARMONIC2_PARAM, -2.39334242818, 1.60665757182, -0.39334242818, "Harmonic 2 Frequency", "Hz", 2, dsp::FREQ_C4);
	...
	configParam(FMTONE_PARAM, -5.f, 5.f, 0.f, "FM Tone Frequency", "Hz", 2, dsp::FREQ_C4);
	configParam(FMCHARACTER_PARAM, -5.f, 5.f, 0.f, "FM Character Frequency", "Hz", 2, dsp::FREQ_C4);
	...
	configParam(NOTCH1_PARAM, -5.f, 5.f, -1.f, "Notch 1 Frequency", "Hz", 2, dsp::FREQ_C4);
	configParam(NOTCH2_PARAM, -5.f, 5.f, 0.f, "Notch 2 Frequency", "Hz", 2, dsp::FREQ_C4);
	configParam(NOTCH3_PARAM, -5.f, 5.f, 1.f, "Notch 3 Frequency", "Hz", 2, dsp::FREQ_C4);
	configParam(LPF_PARAM, -5.f, 5.f, 5.f, "LPF Cutoff Frequency", "Hz", 2, dsp::FREQ_C4);
	configParam(HPF_PARAM, -5.f, 5.f, -5.f, "HPF Cutoff Frequency", "Hz", 2, dsp::FREQ_C4);
...
json_t* Snare::dataToJson()
{
	...
	json_object_set_new(rootJ, "modMatrix", engine->getControls()->modMatrixToJson());
	return rootJ;
}
...
void Snare::dataFromJson(json_t *rootJ)
{
	...
	if (modMatrix != NULL)
		{
			engine->getControls()->modMatrixFromJson(modMatrix);
		}
}
